Shader "Wdx/ShaderBook/NormalMapTangentSpace"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                TANGENT_SPACE_ROTATION;                //Unity内置宏，直接得到rotation变换矩阵

                f.lightDir = mul(rotation, UnityWorldSpaceLightDir(v.vertex)).xyz;

                f.viewDir = mul(rotation, UnityWorldSpaceViewDir(v.vertex)).xyz;
